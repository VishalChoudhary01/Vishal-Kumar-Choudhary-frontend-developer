    ...
    <section id="Home" className="border-b border-neutral-900 pb-4 lg:mb-35">
        <section className="flex flex-wrap">
            ...
            <section className="flex flex-col items-center lg:items-start">
                ...
                <motion.span variants={container(0.5)} initial="hidden" animate="visible" className=" font-[Poppins] text_Hue_Animation bg font-semibold  text-xl md:text-2xl lg:text-3xl tracking-tight">Frontend Developer <span className="text-md md:text-xl lg:text-2xl ml-3"> ( MERN )</span> </motion.span>
