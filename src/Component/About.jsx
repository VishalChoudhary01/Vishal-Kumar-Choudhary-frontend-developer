...
const About = () => {
  return (
    <section id='About' className="border-b border-neutral-900 pb-4">
      ...
      <motion.h1 whileInView={{opacity:1,y:0}} initial={{opacity:0,y:-30}} transition={{duration:0.8,delay:0.5}} className="my-20 heading font-Poppins  text-center text-2xl md:text-3xl lg:text-4xl ">About <span className="text-neutral-500">Me</span> </motion.h1>
